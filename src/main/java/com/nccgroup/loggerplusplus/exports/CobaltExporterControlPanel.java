    ...
    public CobaltExporterControlPanel(CobaltExporter cobaltExporter) {
        ...
        JButton showConfigDialogButton = new JButton(new AbstractAction("Configure Cobalt Exporter") {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                new CobaltExporterConfigDialog(LoggerPlusPlus.instance.getLoggerFrame(), cobaltExporter)
                        .setVisible(true);

                //Dialog closed. Update previous project entry filter to current value.
                String newFilter = cobaltExporter.getPreferences().getSetting(Globals.PREF_ELASTIC_FILTER);
                cobaltExporter.getPreferences().setSetting(Globals.PREF_ELASTIC_FILTER_PROJECT_PREVIOUS, newFilter);
            }
        });
